...
/*
 * The registration_updated event.
 *
 * @package mod_bim
...
/**
 * The registration_updated event class.
 *
...
class registration_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated blogurl for '{$this->relateduserid}' effected user*** to '{$this->other['blogurl']}' for BIM with id '$this->objectid'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'bim', 'changeBlogRegistration',
            'view.php?screen=changeBlogRegistration&id=' . $this->contextinstanceid,
