...
/**
 * The student_viewed event class.
 *
...
class student_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstudentviewed', 'mod_bim');
    }
 
    public function get_description() {
        return "The user with id {$this->userid} viewed posts for {$this->relateduserid} for BIM with id {$this->objectid}.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'bim', 'Student viewed',
