...
/*
 * The markerAllocation_updated event.
 *
 * @package mod_bim
...
/**
 * The markerAllocation_updated event class.
 *
 ...
 *
 **/
class markerAllocation_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated marker allocation for BIM with id '$this->objectid'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'bim', 'markers updated',
            'view.php?tab=markers&id=' . $this->contextinstanceid,
            'Change in allocation', $this->contextinstanceid);
    }
}
