...
/// for demonstrative purposes and to show how the bim
/// iself has been upgraded.

/// For each upgrade block, the file bim/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to bim
        $table = new XMLDBTable('bim');
        $field = new XMLDBField('course');
        $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    /// Launch add field course
        $result = $result && add_field($table, $field);

    /// Define field intro to be added to bim
        $table = new XMLDBTable('bim');
    ...
    /// Define field introformat to be added to bim
        $table = new XMLDBTable('bim');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to bim
        $table = new XMLDBTable('bim');
    ...
    /// Define field timemodified to be added to bim
        $table = new XMLDBTable('bim');
    ...
    /// Define index course (not unique) to be added to bim
        $table = new XMLDBTable('bim');
